...
export default function Home() {
  return (
    <>
      ...
      <motion.div
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1, y: 0, transition: { duration: 1, delayChildren: 0.5 } }}
        viewport={{ once: true }}
      >
        <VStack as='section' align={'center'} justify={'center'} backgroundColor={'siteBackground2'} py={20} px={6} mt={10} mb={12} spacing={10}>
          ...
          <SimpleGrid columns={[1, null, 5]} spacingY={{ base: 6, md: 'revert' }} maxW={{ lg: '100%', xl: '80%' }}>
      ...
      <motion.div
        ...
        whileInView={{ opacity: 1, x: 0, transition: { duration: 0.8, delayChildren: 1 } }}
        viewport={{ once: true }}
      >
